    ...
    <div className="w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4">
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between ">
        ...
        <div className="hidden mdl:inline-flex items-center gap-7">
          ...
          <a href="https://drive.google.com/file/d/1c_7Jt1_l7q7CPA2vb7UQ_YNrez4PDivi/view" target="_blank">
            <motion.button
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center gap-7">
                ...
                <div className="flex gap-4">
                  ...
                  <motion.a
                    ...
                    href="https://www.instagram.com/amaan_gh22/"
                    target="_blank"
                  >
                    <span className="w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 hover:border-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                      <SlSocialInstagram />
              ...
              <motion.a
                ...
                href="mailto:amaan083.hitit2020@gmail.com"
              >
                <p>amaan083.hitit2020@gmail.com</p>
              </motion.a>
            </motion.div>
          </div>
        )}
